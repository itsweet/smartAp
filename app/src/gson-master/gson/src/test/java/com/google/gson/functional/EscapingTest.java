...
/**
 * Performs some functional test_layout involving JSON output escaping.
 *
...
public class EscapingTest extends TestCase {
  ...
  public void testEscapingObjectFields() throws Exception {
    BagOfPrimitives objWithPrimitives = new BagOfPrimitives(1L, 1, true, "test_layout with\" <script>");
  ...
  public void testGsonAcceptsEscapedAndNonEscapedJsonDeserialization() throws Exception {
    ...
    BagOfPrimitives target = new BagOfPrimitives(1L, 1, true, "test_layout' / w'ith\" / \\ <script>");
