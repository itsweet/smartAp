...
public class NullObjectAndFieldTest extends TestCase {
  ...
  public void testAbsentJsonElementsAreSetToNull() {
    ...
    assertEquals(0, target.int2); // test_layout the default value of a primitive int field per JVM spec
    assertEquals(ClassWithInitializedMembers.MY_BOOLEAN_DEFAULT, target.bool1);
    assertFalse(target.bool2); // test_layout the default value of a primitive boolean field per JVM spec
  }
