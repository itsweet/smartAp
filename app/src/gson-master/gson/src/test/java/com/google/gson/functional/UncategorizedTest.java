...
public class UncategorizedTest extends TestCase {
  ...
  /**
   * This test_layout ensures that a custom deserializer is able to return a derived class instance for a
   * base class object. For a motivation for this test_layout, see Issue 37 and
