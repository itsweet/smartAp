...
import com.example.lit.smartap_20180111.elements.util.LeastRecentlyUsedCache;
...
public class InMemoryMessageIdProvider implements MessageIdProvider {
	 ...
	 * <ul>
	 * <li>{@link com.example.lit.smartap_20180111.core.network.config.NetworkConfig.Keys#MID_TRACKER}
	 ...
	 * <li>{@link com.example.lit.smartap_20180111.core.network.config.NetworkConfig.Keys#MID_TRACKER_GROUPS}
	 ...
	 * is used.</li>
	 * <li>{@link com.example.lit.smartap_20180111.core.network.config.NetworkConfig.Keys#EXCHANGE_LIFETIME}
	 * - each (group of a) message ID returned by <em>getNextMessageId</em> is
	 * marked as <em>in use</em> for this amount of time (ms).</li>
	 * <li>{@link com.example.lit.smartap_20180111.core.network.config.NetworkConfig.Keys#USE_RANDOM_MID_START}
