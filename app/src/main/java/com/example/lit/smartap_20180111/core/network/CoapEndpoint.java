 ...
 *                                                    canceled messages
 ******************************************************************************/
package com.example.lit.smartap_20180111.core.network;
...
import com.example.lit.smartap_20180111.core.coap.CoAPMessageFormatException;
import com.example.lit.smartap_20180111.core.coap.EmptyMessage;
import com.example.lit.smartap_20180111.core.coap.Message;
import com.example.lit.smartap_20180111.core.coap.MessageFormatException;
import com.example.lit.smartap_20180111.core.coap.Request;
import com.example.lit.smartap_20180111.core.coap.Response;
import com.example.lit.smartap_20180111.core.network.EndpointManager.ClientMessageDeliverer;
import com.example.lit.smartap_20180111.core.network.config.NetworkConfig;
import com.example.lit.smartap_20180111.core.network.interceptors.MessageInterceptor;
import com.example.lit.smartap_20180111.core.network.serialization.DataParser;
import com.example.lit.smartap_20180111.core.network.serialization.DataSerializer;
import com.example.lit.smartap_20180111.core.network.serialization.TcpDataParser;
import com.example.lit.smartap_20180111.core.network.serialization.TcpDataSerializer;
...
import com.example.lit.smartap_20180111.core.network.stack.BlockwiseLayer;
import com.example.lit.smartap_20180111.core.network.stack.CoapStack;
import com.example.lit.smartap_20180111.core.network.stack.CoapTcpStack;
import com.example.lit.smartap_20180111.core.network.stack.CoapUdpStack;
import com.example.lit.smartap_20180111.core.network.stack.ObserveLayer;
import com.example.lit.smartap_20180111.core.network.stack.ReliabilityLayer;
import com.example.lit.smartap_20180111.core.server.MessageDeliverer;
import com.example.lit.smartap_20180111.elements.Connector;
import com.example.lit.smartap_20180111.elements.CorrelationContext;
import com.example.lit.smartap_20180111.elements.MessageCallback;
import com.example.lit.smartap_20180111.elements.RawData;
import com.example.lit.smartap_20180111.elements.RawDataChannel;
import com.example.lit.smartap_20180111.elements.UDPConnector;
//import com.example.lit.smartap_20180111.elements.tcp.TcpConnector;
import com.example.lit.smartap_20180111.elements.util.DaemonThreadFactory;
...
public class CoapEndpoint implements Endpoint {
	...
	/* (non-Javadoc)
	 * @see com.example.lit.smartap_20180111.core.network.Endpoint#getAddress()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.example.lit.smartap_20180111.core.network.Endpoint#getConfig()
	 */
	@Override
