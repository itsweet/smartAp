 ...
 ******************************************************************************/
package com.example.lit.smartap_20180111.core.network.config;

import com.example.lit.smartap_20180111.core.coap.CoAP;
import com.example.lit.smartap_20180111.core.network.GroupedMessageIdTracker;
...
public class NetworkConfigDefaults {
	...
	public static void setDefaults(final NetworkConfig config) {
		...
		config.setString(NetworkConfig.Keys.CONGESTION_CONTROL_ALGORITHM, "Cocoa"); // see com.example.lit.smartap_20180111.core.network.stack.congestioncontrol
