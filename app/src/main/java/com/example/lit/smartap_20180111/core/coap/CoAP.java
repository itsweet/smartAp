 ...
 *                                                    add CodeClass
 ******************************************************************************/
package com.example.lit.smartap_20180111.core.coap;

import static com.example.lit.smartap_20180111.core.coap.CoAP.MessageFormat.*;
...
public final class CoAP {
	...
	public enum ResponseCode {
		...
		//新增加的
		NO_PERMISSION_ERR(CodeClass.ERROR_RESPONSE,7),

		REQUEST_ENTITY_INCOMPLETE(CodeClass.ERROR_RESPONSE, 8),

		REQUEST_ENTITY_TOO_LARGE(CodeClass.ERROR_RESPONSE,12),

		ACCOUNT_EXISTENT(CodeClass.ERROR_RESPONSE,10),
		ACCOUNT_NON_EXISTENT(CodeClass.ERROR_RESPONSE,11),
		ACCOUNT_OR_PWD_ERR(CodeClass.ERROR_RESPONSE,12),
		ACCOUNT_OFFLINE(CodeClass.ERROR_RESPONSE,13),
		FRIEND_OFFLINE(CodeClass.ERROR_RESPONSE,14),

		FAMILY_NAME_EXSITENT(CodeClass.ERROR_RESPONSE,20),
		FAMILY_MEMBER_NOT_EXISTENT_IN_FAMILY(CodeClass.ERROR_RESPONSE,21),
		FAMILY_MEMBER_EXISTENT_IN_FAMILY(CodeClass.ERROR_RESPONSE,22),
		FAMILY_MEMBER_COOR_EXISTENT_IN_OTHER_FAMILY(CodeClass.ERROR_RESPONSE,23),
		FAMILY_MEMBER_EXISTENT_IN_OTHER_FAMILY(CodeClass.ERROR_RESPONSE,24),
		FAMILY_INVALID_ERR(CodeClass.ERROR_RESPONSE,25),

		REQUEST_STR(CodeClass.ERROR_RESPONSE,26),
		BE_FRIEND(CodeClass.ERROR_RESPONSE,27),
		...
		OTHER_ERR(CodeClass.OTHER_ERROR,0);
		...
		private static ResponseCode valueOfClientErrorCode(final int codeDetail) {
            ...
            case 7: return NO_PERMISSION_ERR;
			case 8: return REQUEST_ENTITY_INCOMPLETE;
			//case 9: return ACCOUNT_OFFLINE;
			case 10: return ACCOUNT_EXISTENT;
			case 11: return ACCOUNT_NON_EXISTENT;
			case 12: return ACCOUNT_OR_PWD_ERR;
			case 13: return ACCOUNT_OFFLINE;
            case 14: return FRIEND_OFFLINE;
			//case 15: return UNSUPPORTED_CONTENT_FORMAT;
            case 20: return FAMILY_NAME_EXSITENT;
            case 21: return FAMILY_MEMBER_NOT_EXISTENT_IN_FAMILY;
            case 22: return FAMILY_MEMBER_EXISTENT_IN_FAMILY;
            case 23: return FAMILY_MEMBER_COOR_EXISTENT_IN_OTHER_FAMILY;
            case 24: return FAMILY_MEMBER_EXISTENT_IN_OTHER_FAMILY;
            case 25: return FAMILY_INVALID_ERR;
            case 26: return REQUEST_STR;
            case 27: return BE_FRIEND;
			default:
				return BAD_REQUEST;
			}
		}
